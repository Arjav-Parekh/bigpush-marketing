...
function CaseStudy(){
    return(
        ...
        <div className="title-container" style={{textAlign: 'center', background: 'rgba(48, 191, 217, 0.32)'}}> 
        ...
        <div className="video-continue-container">
          <p>98.6% of e-commerce brand that successfully implements the frameworks <br /> explained in this video will add an extra 10k-100k to their MRR</p>
          <br />
          <button className="join-button" style={{fontWeight: 600}}>Let's Talk</button>
        </div>
        <div className="why-container" style={{backgroundColor: '#fff'}}>
          <h1>Fiercely Ramping Isn't Brain Surgery</h1>
          <p>And it can be achieved, profitably, in 3 months or less.</p>
        ...
        <div className="who-container">
          ...
          <ul style={{listStyleImage: `url(${RightArrow})` }}> 
            <li>Founders who feel as though they are plateauing and can't break through the inflection point.</li>
            <li>Founders who aren't experiencing a healthy MoM increase year round (or feel as though they could have a higher MoM growth rate). </li>
            <li>Founders that are tired of working with agencies that promise the world and deliver nothing.</li>
            <li>Founders that want to actually get to 1M-5M ARR through unmatched sales funnels and high level paid traffic.</li>
            <li>Founders who are deeply seeking to become the industry leader and flatten competition.</li>
          </ul>
        </div>
        <Footer />
        </>
