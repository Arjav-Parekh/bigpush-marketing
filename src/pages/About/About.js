...
function About(){
    return(
        ...
        <div className="title-container" style={{textAlign: 'center'}} data-aos="fade-up" data-aos-delay="50" data-aos-duration="1200"> 
        ...
        <div className="business-container" style={{textAlign: 'center'}}>
          <h1 data-aos="fade-up" data-aos-delay="50" data-aos-duration="1200">We Are Business Success Experts! </h1>
          <p data-aos="fade-up" data-aos-delay="50" data-aos-duration="1200">Welcome to Big Push Marketing Business Solutions. We’re the all-in-one business partner that you’ve been looking for!</p>
          <img src={Business} alt="" data-aos="fade-right" data-aos-delay="50" data-aos-duration="1200" />
          <br />
          <div className="row" >
        ...
        <div className="values-container">
          <h1 data-aos="fade-up" data-aos-delay="50" data-aos-duration="1200">Our Values</h1>
          <div className="row" >
            <div className="col-lg-6 cost-indi val-ind" style={{marginTop:"0"}} data-aos="fade-right" data-aos-delay="50" data-aos-duration="1200">
              <div className="circle-blue" />
              <br />
              <h5>INTEGRITY</h5>
              <p>We say what we mean and we mean what we say. We keep our word and honour our commitments.</p>
            </div> 
            <div className="col-lg-6 cost-indi val-ind" data-aos="fade-left" data-aos-delay="50" data-aos-duration="1200">
              <div className="circle-blue" />
              <br />
            ...
            <div className="col-lg-6 cost-indi value-cols val-ind" data-aos="fade-right" data-aos-delay="50" data-aos-duration="1200">
              <div className="circle-blue" />
              <br />
              <h5>CUSTOMER FOCUS</h5>
              <p>Our solutions aren’t about us, they’re about you. We tailor-make our strategies to suit your needs.</p>
            </div> 
            <div className="col-lg-6 cost-indi value-cols val-ind" data-aos="fade-left" data-aos-delay="50" data-aos-duration="1200">
              <div className="circle-blue" />
              <br />
              <h5>TRANSPARENCY</h5>
        ...
        <div className="schedule-container" style={{backgroundColor: 'white'}}>
          <h1 className="schedule-h1" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1200" style={{marginBottom:"0"}}>Interested To Get Started?</h1>
          <div className="row">
            <div className="col-lg-6 left-schedule-col" style={{marginTop: 'auto', marginBottom: 'auto'}}>
              <h2 data-aos="fade-right" data-aos-delay="50" data-aos-duration="1200">Let's Talk</h2>
              <p data-aos="fade-right " data-aos-delay="50" data-aos-duration="1200">Reach out to learn more, and get the conversation started.</p>
            </div>
            <div className="col-lg-6">
              <img src={Schedule} alt="" data-aos="fade-left" data-aos-delay="50" data-aos-duration="1200" />
            </div>
          </div>
        </div>
        <Footer />
